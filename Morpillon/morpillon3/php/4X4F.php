...
if($equipe2[0]==1)
{
  ...
  if($joueur2[0]==0)
  {
	 $req=mysqli_fetch_all($connexion->query('select IDEq from matrice where IDpos<=16;'));
		for ($i=0;$i<16;$i=$i+4)
		{
			if($req[$i][0]!=0)
			{				
			if($req[$i][0]==$req[$i+1][0] && $req[$i][0]==$req[$i+2][0] && $req[$i][0]==$req[$i+3][0])
			{
				$connexion->query('update jeu set verifjo=3;');?>
					...
					<form name="formcreation" method="post" action="index.php?page=4X4F.php">
					<table width="100%">
		...
		for ($i=0;$i<4;$i++)
		{
			if ($req[$i][0]!=0)
			{
			if($req[$i][0]==$req[$i+4][0] && $req[$i][0]==$req[$i+8][0] && $req[$i][0]==$req[$i+12][0])
			{
				$connexion->query('update jeu set verifjo=3;');?>
					<fieldset style="border:solid 1px black; padding:20px; width:60%;">
					<h3> fin de la partie</h3> 
		...
		if ($req[0][0]!=0)
		{
		if($req[0][0]==$req[5][0] && $req[0][0]==$req[10][0] && $req[0][0]==$req[15][0])
			{
				$connexion->query('update jeu set verifjo=3;');?>
					<fieldset style="border:solid 1px black; padding:20px; width:60%;">
					<h3> fin de la partie</h3> 
		...
		if ($req[3][0]!=0)
		{
		if($req[3][0]==$req[6][0] && $req[3][0]==$req[9][0] && $req[3][0]==$req[12][0])
			{
				$connexion->query('update jeu set verifjo=3;');?>
					<fieldset style="border:solid 1px black; padding:20px; width:60%;">
					<h3> fin de la partie</h3> 
					...
					<tr style="text-align:center;">
					<?php echo '<td colspan=2><br/><br/><input type="submit" style="font-variant: small-caps;" name="bfin2" value="'.$req[3][0].'"></td>';?>
					</tr></table>
					</form>
					</fieldset>
				<?php 
	...
	<h3> choix de la ncase ou poser le morpion</h3> 
		...
		<tr>
			...
			<option value=5>2X1</option>
			<option value=6>2X2</option>
			<option value=7>2X3</option>
			<option value=8>2X4</option>
			<option value=9>3X1</option>
			<option value=10>3X2</option>
			<option value=11>3X3</option>
			<option value=12>3X4</option>
			<option value=13>4X1</option>
			<option value=14>4X2</option>
			<option value=15>4X3</option>
	...
	$z=0;
		...
		if($sel[0]!=0 || $sel[0]!=-1)
		{
			...
			if($sel1[0]==1)
			{
				if($_POST['case']==($_POST['attaquant']+1) || $_POST['case']==($_POST['attaquant']-1) || $_POST['case']==($_POST['attaquant']+4) || $_POST['case']==($_POST['attaquant']-4))
				{
 ...
 <?php 
  ...
  else{if($joueur2[0]==1)
  {
	  $req=mysqli_fetch_all($connexion->query('select IDEq from matrice where IDpos<=16;'));
		...
		if ($req[0][0]!=0)
		{
		if($req[0][0]==$req[5][0] && $req[0][0]==$req[10][0] && $req[0][0]==$req[10][0])
			{
				$connexion->query('update jeu set verifjo=3;');?>
					<fieldset style="border:solid 1px black; padding:20px; width:60%;">
					<h3> fin de la partie</h3> 
...
?>
	...
	<h3> choix de la ncase ou lancer le nsort</h3> 
		...
		<tr>
			...
			$req1=mysqli_fetch_array($connexion->query('select count(IDMo) from matrice where IDeq='.$req[0].' and IDMo in (select IDMo from sorcerer);'));
			$req0=mysqli_fetch_all($connexion->query('select IDMo,IDpos from matrice where IDeq='.$req[0].' and IDMo in (select IDMo from sorcerer);'));
			echo 'select IDMo,IDpos from matrice where IDeq=1 and IDMo in (select IDMo from sorcerer);';
			?>
			<select name="case" id="idcase">;
			<?php for ($i=0;$i<$req1[0];$i++)
			{
...
<td class="tdtrav"><img src="./img/quatre.png" width=150px height=150px /></td>
</tr>
<tr>
...
echo '<a href="#"><img src="'.$value5[2].'" width=150px height=150px/><span>attaque : '.$value5[4].' , vie : '.$value5[3].' , mana : '.$value5[5].' , crit : '.$value5[6].' <br/>, equipe :'.$test5[0].' , morpion :'.$test6[0].'</span>';?></td>
<td class="tdtrav"><?php 
...
echo '<a href="#"><img src="'.$value7[2].'" width=150px height=150px/><span>attaque : '.$value7[4].' , vie : '.$value7[3].' , mana : '.$value7[5].' , crit : '.$value7[6].' <br/>, equipe :'.$test7[0].' , morpion :'.$test8[0].'</span></a>';?></td>
</tr>
<tr>
...
echo '<a href="#"><img src="'.$value9[2].'" width=150px height=150px/><span>attaque : '.$value9[4].' , vie : '.$value9[3].' , mana : '.$value9[5].' , crit : '.$value9[6].' <br/>, equipe :'.$test9[0].' , morpion :'.$test10[0].'</span></a>';?></td>
<td class="tdtrav"><?php
...
<td class="tdtrav"><?php 
$value18=$connexion->query('select * from matrice where IDpos=10;');
$value19=mysqli_fetch_array($value18);
$test19=mysqli_fetch_array($connexion->query('select name,color from team where IDEq='.$value19[7].';'));
$test20=mysqli_fetch_array($connexion->query('select name from morpion where IDMo='.$value19[1].';'));
echo '<a href="#"><img src="'.$value19[2].'" width=150px height=150px/><span>attaque : '.$value19[4].' , vie : '.$value19[3].' , mana : '.$value19[5].' , crit : '.$value19[6].' <br/>, equipe :'.$test19[0].' , morpion :'.$test20[0].'</span></a>';?></td>
<td class="tdtrav"><?php
$value20=$connexion->query('select * from matrice where IDpos=11;');
$value21=mysqli_fetch_array($value20);
$test21=mysqli_fetch_array($connexion->query('select name,color from team where IDEq='.$value21[7].';'));
$test22=mysqli_fetch_array($connexion->query('select name from morpion where IDMo='.$value21[1].';'));
echo '<a href="#"><img src="'.$value21[2].'" width=150px height=150px/><span>attaque : '.$value21[4].' , vie : '.$value21[3].' , mana : '.$value21[5].' , crit : '.$value21[6].' <br/>, equipe :'.$test21[0].' , morpion :'.$test22[0].'</span></a>';?></td>
<td class="tdtrav"><?php
$value22=$connexion->query('select * from matrice where IDpos=12;');
$value23=mysqli_fetch_array($value22);
$test23=mysqli_fetch_array($connexion->query('select name,color from team where IDEq='.$value23[7].';'));
$test24=mysqli_fetch_array($connexion->query('select name from morpion where IDMo='.$value23[1].';'));
echo '<a href="#"><img src="'.$value23[2].'" width=150px height=150px/><span>attaque : '.$value23[4].' , vie : '.$value23[3].' , mana : '.$value23[5].' , crit : '.$value23[6].' <br/>, equipe :'.$test23[0].' , morpion :'.$test24[0].'</span></a>';?></td>
</tr>
<tr>
<th class="thtrav"><img src="./img/quatre.png" width=150px height=150px /></th>
<td class="tdtrav"><?php 
$value24=$connexion->query('select * from matrice where IDpos=13;');
$value25=mysqli_fetch_array($value24);
$test25=mysqli_fetch_array($connexion->query('select name,color from team where IDEq='.$value25[7].';'));
$test26=mysqli_fetch_array($connexion->query('select name from morpion where IDMo='.$value25[1].';'));
echo '<a href="#"><img src="'.$value25[2].'" width=150px height=150px/><span>attaque : '.$value25[4].' , vie : '.$value25[3].' , mana : '.$value25[5].' , crit : '.$value25[6].' <br/>, equipe :'.$test25[0].' , morpion :'.$test26[0].'</span></a>';?></td>
<td class="tdtrav"><?php 
$value26=$connexion->query('select * from matrice where IDpos=14;');
$value27=mysqli_fetch_array($value26);
$test27=mysqli_fetch_array($connexion->query('select name,color from team where IDEq='.$value27[7].';'));
$test28=mysqli_fetch_array($connexion->query('select name from morpion where IDMo='.$value27[1].';'));
echo '<a href="#"><img src="'.$value27[2].'" width=150px height=150px/><span>attaque : '.$value27[4].' , vie : '.$value27[3].' , mana : '.$value27[5].' , crit : '.$value27[6].' <br/>, equipe :'.$test27[0].' , morpion :'.$test28[0].'</span></a>';?></td>
<td class="tdtrav"><?php
$value28=$connexion->query('select * from matrice where IDpos=15;');
$value29=mysqli_fetch_array($value28);
$test29=mysqli_fetch_array($connexion->query('select name,color from team where IDEq='.$value29[7].';'));
$test30=mysqli_fetch_array($connexion->query('select name from morpion where IDMo='.$value29[1].';'));
echo '<a href="#"><img src="'.$value21[2].'" width=150px height=150px/><span>attaque : '.$value29[4].' , vie : '.$value29[3].' , mana : '.$value29[5].' , crit : '.$value29[6].' <br/>, equipe :'.$test29[0].' , morpion :'.$test30[0].'</span></a>';?></td>
<td class="tdtrav"><?php
$value30=$connexion->query('select * from matrice where IDpos=16;');
$value31=mysqli_fetch_array($value30);
$test31=mysqli_fetch_array($connexion->query('select name,color from team where IDEq='.$value31[7].';'));
$test32=mysqli_fetch_array($connexion->query('select name from morpion where IDMo='.$value31[1].';'));
echo '<a href="#"><img src="'.$value31[2].'" width=150px height=150px/><span>attaque : '.$value31[4].' , vie : '.$value31[3].' , mana : '.$value31[5].' , crit : '.$value31[6].' <br/>, equipe :'.$test31[0].' , morpion :'.$test32[0].'</span></a>';?></td>
</tr>
</table>