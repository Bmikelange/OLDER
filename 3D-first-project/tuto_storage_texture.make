...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto_storage_texture
  TARGETDIR  = bin
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto_storage_texture
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_storage_texture
  DEFINES   +=
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto_storage_texture
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_storage_texture
  DEFINES   += -DDEBUG
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto_storage_texture
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_storage_texture
  DEFINES   +=
  INCLUDES  += -I. -Isrc/gKit
