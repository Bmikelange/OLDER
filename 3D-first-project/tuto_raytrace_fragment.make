...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto_raytrace_fragment
  TARGETDIR  = bin
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto_raytrace_fragment
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_raytrace_fragment
  DEFINES   +=
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto_raytrace_fragment
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_raytrace_fragment
  DEFINES   += -DDEBUG
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto_raytrace_fragment
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_raytrace_fragment
  DEFINES   +=
  INCLUDES  += -I. -Isrc/gKit
