...
if(isset($_POST['bRechercher'])) {
	if(isset($_POST['valeur']) && trim($_POST['valeur']) != '') {
		...
		// construction de la requete
			$requete = 'SELECT titre, categorie,nbDePersonne FROM recette WHERE titre LIKE \'%'.$valeur.'%\';';
...
<h1>Recherche dans la base</h1>
	...
	<!-- <legend style="font-size:11; font-weight:bold;"> Recherche </legend> -->
		<form name="formRecherche" method="post" action="index.php?page=affichage.php">
		<table width="100%">
		<tr>
