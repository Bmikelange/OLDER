...
if(isset($_POST['bRechercher1'])) {
	if(isset($_POST['valeur']) && trim($_POST['valeur']) != '' && isset($_POST['champRech'])) {
		...
		if($_POST['champRech'] == 'zonegeographique') {
			$requete = 'SELECT * FROM '.$table.' WHERE continent =\''.$valeur.'\'AND paysGeo =\''.$valeur2.'\'';
